                ...
                <form onSubmit={onRegister}>
                    <FormControl display="flex"  flexDirection="column" justify="center" alignItems="center" gap="10px">
                        ...
                        <Box w="100%"><FormLabel>Avatar</FormLabel>
                            <Input id="avatar" borderRadius="md" type="file" onChange={updateImage}  autoComplete="off" accept='.jpg,.png,.jpeg' />
                        </Box>
                        
                        <Button borderRadius="md"  colorScheme='gray' variant='outline' w="100%" type='submit' >Register</Button>
                    </FormControl>
                </form>
